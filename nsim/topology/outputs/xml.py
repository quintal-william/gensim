...
class XmlTopologyOutput(XmlOutput[Node]):
    def __make_edge_element(self, edge: Edge) -> ElementTree.Element:
        ...
        return self._make_element(edge_type, edge.get_id(), attributes)

    def __make_leaf_element(self, leaf: Leaf) -> ElementTree.Element:
        element = self._make_element(leaf.get_type().value.lower(), leaf.get_id())
    ...
    def __make_topology_element(self, topology: Topology) -> ElementTree.Element:
        ...
        element = self._make_element(topology_type, topology.get_id())
    ...
    def __make_node_element(self, node: Node) -> ElementTree.Element:
        ...
        return self._make_element(node.__class__.__name__.lower(), node.get_id())
